...
public class Crud {
    ...
    static final String USER = "giovanna";
    static final String PASS = "PercyJackson15@12";
    ...
    static void read() throws SQLException {
      ...
      try(Statement mtmt = conn.createStatement(); ResultSet rs = stmt.executeQuerry(sql)) {
          whille (rs.next()) {
